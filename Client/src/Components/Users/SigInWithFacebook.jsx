    ...
    return (
        <>
            <LoginSocialFacebook
                ...
                <button
                    class="sign-with-account w-full  max-w-xs font-bold shadow-md rounded-lg p-3 bg-indigo-100 text-gray-800 flex items-center justify-center hover:shadow-blue-600  transition duration-300 focus:shadow-none focus:translate-y-0.5 focus:scale-110 hover:-translate-y-1 hover:scale-110 mt-5"
                >
